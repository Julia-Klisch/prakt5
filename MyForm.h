...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->richTextBox1->Size = System::Drawing::Size(706, 414);
			...
			this->statusStrip1->Size = System::Drawing::Size(706, 26);
			...
			this->menuStrip1->Size = System::Drawing::Size(706, 28);
...
private: System::Void Ô‡ÌÂÎ≥≤ÌÒÚÛÏÂÌÚ≥‚ToolStripMenuItem_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
	bool prap;
	if (Ô‡ÌÂÎ≥≤ÌÒÚÛÏÂÌÚ≥‚ToolStripMenuItem->Checked)
		prap = true;
	else
		prap = false;
	if (prap == true)
